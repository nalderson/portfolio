  ...
  return <section>
    <div className="project-section">
      ...
      <div className="individual-project">
        ...
        <img className="project-img" src="../images/Amstel.png" />
      ...
      <div className="individual-project">
        ...
        <img className="project-img" src="../images/Halifax.jpg" />
      ...
      <div className="individual-project">
        ...
        <img className="project-img" src="../images/Samsung.png" />
      ...
      <div className="individual-project">
        ...
        <img className="project-img" src="../images/Pixel.png" />
